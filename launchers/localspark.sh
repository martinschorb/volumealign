...
JOB="localspark"
export MASTER_URL="local[$WORKER_CPU]" #spark://$(hostname):7077"
...
export SPARK_WORKER_CORES=$WORKER_CPU

export TOTAL_CORES=$WORKER_CPU #$(($SPARK_WORKER_CORES * $WORKER_NODES))

# export SPARK_DRIVER_MEM=$((4 * 1024))

export SPARK_MEM=$(( $WORKER_MEMPERCPU * $SPARK_WORKER_CORES))m
