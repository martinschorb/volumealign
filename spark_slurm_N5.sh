...
RENDERPARAMS="--baseUrl http://pc-emcf-16.embl.de:8080/render-ws/v1 --owner SBEM --stack 3D_results0 --project tests"
PARAMS="--n5Path /g/emcf/schorb/render-output/test-3D.n5 --n5Dataset /render --tileSize 2048,1536 --min -10784,-210502,442 --size 75044,68142,9 --blockSize 128,128,64"
